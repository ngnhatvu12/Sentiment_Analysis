...
# ----------------- CẤU HÌNH -----------------
CRAWLERS = [
    r"C:\CrawlerEXE\group_sentiment\exe_rumor.exe", #rumor
    r"C:\CrawlerEXE\group_sentiment\exe_trending_words.exe", #api_sentiment_trending_keyword
    r"C:\CrawlerEXE\group_sentiment\exe_summary.exe", #top_stock_sentiment, stock_sentiment
    r"C:\CrawlerEXE\group_sentiment\exe_yt_advise.exe", #api_sentiment_youtuber_advise
]
